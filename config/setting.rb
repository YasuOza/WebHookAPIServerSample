...
set :twtrclient, Twitter::REST::Client.new { |config|
  config.consumer_key        = ENV['twtr_consumer_key']  || 'consumer_key'
  config.consumer_secret     = ENV['consumer_secret']    || 'consumer_secret'
  config.access_token        = ENV['your_oauth_token']   || 'your_oauth_token'
  config.access_token_secret = ENV['oauth_token_secret'] || 'oauth_token_secret'
}
